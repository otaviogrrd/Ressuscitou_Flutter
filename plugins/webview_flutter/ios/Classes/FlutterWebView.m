...
- (void)onMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
  ...
  } else if ([[call method] isEqualToString:@"canScrollVertically"]) {
    [self onCanScrollVertically:call result:result];
  } else {
...
- (void)onCanScrollVertically:(FlutterMethodCall*)call result:(FlutterResult)result {
  int offsetY = _webView.scrollView.contentOffset.y;
  int totalY = ( _webView.scrollView.contentSize.height - _webView.scrollView.frame.size.height );
  if ( totalY > offsetY ) {
